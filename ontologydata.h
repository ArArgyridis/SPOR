...
typedef boost::shared_ptr<OntologyClass> OntologyClassPtr;

typedef std::map<std::string, OntologyClassPtr> ClassMapType;

typedef boost::shared_ptr<ClassMapType> ClassMapTypePtr;


class SuperClassNode;

typedef boost::shared_ptr<SuperClassNode> SuperClassNodePtr;

typedef  std::map <std::string, SuperClassNodePtr> SuperClassNodeMapType;

typedef  boost::shared_ptr<SuperClassNodeMapType> SuperClassNodeMapTypePtr;
...
class OntologyData {
    ...
    int *segNumber;
    std::string  *connectionParameter, fuzzyOwlDatatypeProperties [], *gidColumn, *geomColumn, *neighborTblName, *neighborTblid, *neighborTblidNeigh, *ontologyIRI, *selectStr,  *tableName;
...
typedef boost::shared_ptr<OntologyData> OntologyDataPtr;
