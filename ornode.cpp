...
OrNode::OrNode() {
    setMembershipValue(OR_NODE_NULL);
     setNodeType(OR);
    parentNodesSumType  = OR;
}
...
void OrNode::valueEstimation(int curSegment) {
    this->setMembershipValue(OR_NODE_NULL);
